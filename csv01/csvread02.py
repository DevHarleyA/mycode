...
def main():
    with open('superbirthday.csv', mode='r') as csv_file:
        ...
        # create a file called regularbirthday.csv without heroname
        # doesn't work
        # with open('regularbirthday.csv', 'w') as no_heroname:
            # for row in csv_reader:
                # no_heroname.write('\t{} was born in {}'.format(row["name"],row["birthday month"]))
